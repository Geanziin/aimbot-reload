...
public class Aimbot : UserControl
{
  ...
  private string AimbotScan = "FF FF FF FF 00 00 00 00 00 00 00 00 FF FF FF FF 00 00 00 00 00 00 00 00 00 00 00 00 ? ? ? ? 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 ? ? ? ? 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 01 01 01 01";
  private string headoffset = "0x2CC";
  private string chestoffset = "0x2C8";
  private string AimbotScan1 = "FF FF FF FF 00 00 00 00 00 00 00 00 FF FF FF FF 00 00 00 00 00 00 00 00 00 00 00 00 ? ? ? ? 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 ? ? ? ? 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 01 01 01 01";
  private string headoffset1 = "0x30C";
  private string chestoffset1 = "0x2C8";
  ...
  private void ApplyPrecisionValuesSync(bool activate)
  {
    try
    {
      ...
      string precisionPattern = "00 00 5c 41 00 00 0f 37 00 00 14 41 00 00 c8 44";
